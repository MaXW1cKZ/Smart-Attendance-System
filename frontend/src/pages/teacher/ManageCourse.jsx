        ...
        <div className="flex items-center justify-between mb-1">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <div
              ...
              className={`w-11 h-6 rounded-full transition-all relative cursor-pointer ${form.use_late_absent ? "bg-teal-500" : "bg-gray-200"}`}
            >
              <div
                className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-all ${form.use_late_absent ? "left-5" : "left-0.5"}`}
              />
            </div>
          </label>
        </div>
